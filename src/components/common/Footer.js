  ...
  <footer className="bg-ocean-gradient text-white mt-16 relative wave-decoration">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-28">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div>
          <div className="flex items-center gap-2 mb-4">
            <div className="bg-white/20 p-2 rounded-xl"><GiTropicalFish className="w-6 h-6" /></div>
            <span className="font-display font-bold text-xl">AquaMart</span>
          </div>
        ...
        <div>
          ...
          <ul className="space-y-3 text-ocean-200 text-sm">
            <li className="flex items-start gap-2"><FiMapPin className="w-4 h-4 mt-0.5 flex-shrink-0" /><span>123 Aqua Street, Chennai, Tamil Nadu 600001</span></li>
            <li className="flex items-center gap-2"><FiPhone className="w-4 h-4" /><span>+91 98765 43210</span></li>
            <li className="flex items-center gap-2"><FiMail className="w-4 h-4" /><span>hello@aquamart.in</span></li>
          </ul>
        </div>
      </div>
      ...
      <div className="border-t border-white/20 mt-10 pt-6 flex flex-col sm:flex-row justify-between items-center text-ocean-200 text-sm">
        <p>© {new Date().getFullYear()} AquaMart. All rights reserved.</p>
        <p className="mt-2 sm:mt-0">Built with 💙 for aquatic enthusiasts</p>
      </div>
    </div>
  </footer>
);
